...
import com.cyberland.felix.myibeaconapplication.Trilateration.Vector;
...
public class MainActivity extends Activity implements BeaconConsumer {
    ...
    public String distanz5;
    private double numDistanz2;
    private double numDistanz3;
    private double numDistanz4;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DistanzView5 = (TextView) findViewById(R.id.d5);
            ...
            public void didRangeBeaconsInRegion(final Collection<Beacon> beacons, Region region)
            {
                ...
                if (beacons.size() > 0)
                {
                            ...
                            beacons)
                    {
                        ...
                        {
                            distanz1 = (""+b.getDistance()).substring(0,6);
                        }
                        if(b.getId3().toInt() == trilaterationTool.beaconID2)
                        {
                            distanz2 = (""+b.getDistance()).substring(0,6);
                            numDistanz2 = b.getDistance();
                        }
                        if(b.getId3().toInt() == trilaterationTool.beaconID3)
                        {
                            distanz3 = (""+b.getDistance()).substring(0,6);
                            numDistanz3 = b.getDistance();
                        }
                        if(b.getId3().toInt() == trilaterationTool.beaconID4)
                        {
                            distanz4 = (""+b.getDistance()).substring(0,6);
                            numDistanz4 = b.getDistance();
                        }
                    }
                    trilaterationTool.updateDistances(beacons);
                    localisationString= trilaterationTool.trilaterateFourBeacons(beacons).toString();
                    localisationString= new Vector(numDistanz3/(numDistanz2+numDistanz3)*7,0.0).toString();
    ...
    public void neueMessung(View view)
    {
        distanz1 = "";
        distanz2 = "";
        distanz3 = "";
